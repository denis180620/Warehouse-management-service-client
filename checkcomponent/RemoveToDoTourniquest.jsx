...
import { removeToTourniquest } from '../services/ApiTourniquest';


function RemoveToTourniquest() {
    ...
    const submitChange = async (e) => {
        ...
        try {
            const dataform = await removeToTourniquest(data);
            setResult(dataform);
        } catch (err) {
            setError(err)
        } finally {
    ...
    return (
        <div className="card">
            <div className="card-header">
                <h3>Списание жгутов со склада</h3>
            </div>
            <div className="card-body">
                <form onSubmit={submitChange}>
                    ...
                    <div className="mb-3">
                        <label htmlFor="updateQuantity" className="form-label">Количесвто списываемых жгутов</label>
                    ...
                    <button type="submit" className="btn btn-primary" disabled={loading}>
                        {loading ? 'Обновление....' : 'Списать со склада'}
                    </button>
                </form>
...
export default RemoveToTourniquest;